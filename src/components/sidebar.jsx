...
const NavElements = [
    {
        name: "Logo",
        icon: <svg width="32" height="37" viewBox="0 0 32 37" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="32" height="36.7092" rx="4" fill="white"/>
            <path fillRule="evenodd" clipRule="evenodd" d="M21.8793 8.98199H14.3992L13.4945 13.6847H12.4945L13.5868 8.00699H14.1876L14.1889 8H23.0544L23.053 8.00699H23.0669L21.9746 13.6847H20.9746L21.8793 8.98199Z" fill="#105E46"/>
            <rect width="12.3346" height="14.8015" transform="matrix(1 0 -0.188924 0.981992 11.6655 14.1742)" fill="#12805D"/>
            <rect width="12.3346" height="14.8015" transform="matrix(1 0 -0.188924 0.981992 10.7963 13.4034)" fill="#02D693"/>
        </svg>,
    },
    {
        name: "Menu",
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.125 7.125H12H19.875M4.125 12H19.875M4.125 16.875H19.875" stroke="#1A1F16" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round"/>
            </svg>
        ),
    },
    {
    ...
    },
    {
        ...
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.5909 12L18.0441 7.54687C18.2554 7.3359 18.3743 7.04961 18.3745 6.75099C18.3748 6.45237 18.2564 6.16587 18.0455 5.95453C17.8345 5.74319 17.5482 5.62431 17.2496 5.62404C16.951 5.62378 16.6645 5.74215 16.4531 5.95312L12 10.4062L7.54687 5.95312C7.33553 5.74178 7.04888 5.62305 6.75 5.62305C6.45111 5.62305 6.16447 5.74178 5.95312 5.95312C5.74178 6.16447 5.62305 6.45111 5.62305 6.75C5.62305 7.04888 5.74178 7.33553 5.95312 7.54687L10.4062 12L5.95312 16.4531C5.74178 16.6645 5.62305 16.9511 5.62305 17.25C5.62305 17.5489 5.74178 17.8355 5.95312 18.0469C6.16447 18.2582 6.45111 18.3769 6.75 18.3769C7.04888 18.3769 7.33553 18.2582 7.54687 18.0469L12 13.5937L16.4531 18.0469C16.6645 18.2582 16.9511 18.3769 17.25 18.3769C17.5489 18.3769 17.8355 18.2582 18.0469 18.0469C18.2582 17.8355 18.3769 17.5489 18.3769 17.25C18.3769 16.9511 18.2582 16.6645 18.0469 16.4531L13.5909 12Z" fill="#1A1F16"/>
            </svg>
        ),
    },
];
        ...
        <>
            ...
            <div className="md:hidden fixed top-0 left-0 right-0 bg-white z-50 shadow-sm">
                <div className="flex items-center justify-between p-4">
                    ...
                    >
                        {mobileMenuOpen ? NavElements[5].icon : NavElements[1].icon}
                    </button>
                </div>
            </div>
            ...
            {/* Mobile Menu */}
            <div
                className={`md:hidden fixed top-[73px] right-0 h-[calc(100vh-73px)] w-64 bg-white z-40 transform transition-all duration-400 ease-in-out ${
            ...
            <nav className="hidden md:block bg-[#F3F3F3] h-screen w-[120px] p-4">
                ...
                >
                    ...
                    {/* Logout */}
                    <button className="p-2 bg-[#E5252C] rounded-[10px] flex items-center gap-3 hover:bg-[#c91f24] transition-colors">
                        {NavElements[4].icon}
                        {open && <span className="text-white font-medium">Logout</span>}
                    </button>
                </div>
            </nav>
        </>
