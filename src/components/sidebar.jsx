...
const NavElements = [
    ...
    },
    {
        name: "Store",
        icon: (
            <svg className="fill=[#1A1F16]  hover:fill-white" width="24" height="24" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
        ...
        <>
            ...
            <nav className="hidden md:block bg-[#F3F3F3] h-screen w-[120px] p-4">
                ...
                >
                    ...
                    {/* Logout */}
                    <button className="p-2 bg-[#E5252C] rounded-[10px] flex items-center gap-3 hover:bg-[#c91f24] transition-colors cursor-pointer">
                        {NavElements[4].icon}
